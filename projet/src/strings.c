...
/*   Updated: 2015/03/22 02:06:47 by vchaillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_color_strings(t_env *e)
{
	if (e->color_menu == ON)
	{
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 5,
				WHITE, "Red 1");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 8,
				WHITE, "Green 2");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 11,
				WHITE, "Blue 3");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 14,
				WHITE, "Yellow 4");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 17,
				WHITE, "Pink 5");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 20,
				WHITE, "Orange 6");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 23,
				WHITE, "Brown 7");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 26,
				WHITE, "L_Blue 8");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 29,
				WHITE, "D_Grey 9");
		mlx_string_put(e->mlx, e->win, (CASE_W) + (TEXT_W), (TEXT_H) * 32,
				WHITE, "White 0");
	}
}
